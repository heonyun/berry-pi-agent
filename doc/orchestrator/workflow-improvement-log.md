...
| deepseek-pr-review-quality | 2026-07-04 | promoted | False positives, comment spam, fail vs CI mismatch | Domain invariants + test harness context + CI downgrade + upsert/skip duplicate head | harness-flow.md § DeepSeek PR review |
